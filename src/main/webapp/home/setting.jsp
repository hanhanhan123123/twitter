	...
	<div style="flex: 5; ">
			...
			<input type="hidden" name="id" value="<%=user.getId()%>"/>
				...
				<div style="margin: 0.2em">
					<h4 style="text-align: left; margin: 0.1em">프로필 이미지</h4>
					<input type="file" placeholder="이미지 선택" class="join-input" name="attath" style="width: 70vw" accept="image/*"/>
				</div>
				<div style="margin: 0.2em">
					<h4 style="text-align: left; margin: 0.1em">대표 닉네임</h4>
					<input type="text" placeholder="아이디" class="join-input" name="nick"
					value="<%=user.getNick()%>" style="width: 20vw" />
				</div>
					<div style="margin: 0.2em">
