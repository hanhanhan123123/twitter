...
<div style="display: flex; height: 100vh; gap: 10px; ">
	...
	<div style="flex: 5; overflow-y:scroll">
		...
		<%-- 최신 트윗 뷰 영역 --%>
		<div style = "margin:flex; align-items: baseline;">
		<h3 > 최신 트윗들 </h3>
		<div>
		<a href="">전체보기</a>
		</div>
		...
		<div style="padding:10px; border: 1px solid #dddddd; margin-bottom: 5px; border-radius: 10px">
		<div>
		<%=tweet.getWriter() %><small><%=tweet.getWirerNick() %></small>
		</div>
